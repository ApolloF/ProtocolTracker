...
import com.apollof.protocoltracker.ui.history.HistoryScreen
...
private val tabs = listOf(
    ...
    Tab(LevelsRoute, LevelsRoute::class, "Levels", Icons.Outlined.ShowChart, Icons.Filled.ShowChart),
    Tab(HistoryRoute, HistoryRoute::class, "History", Icons.Outlined.History, Icons.Filled.History),
)
...
fun AppNav(nav: NavHostController = rememberNavController()) {
    ...
    Scaffold(
        ...
        NavHost(nav, startDestination = TodayRoute, modifier = Modifier.padding(padding).consumeWindowInsets(padding)) {
            ...
            composable<HistoryRoute> { HistoryScreen(onOpenSettings = settings) }
