...
class ImportAndBackupTest {
    ...
    {"format":"cycletracker-1","exportedAt":"2026-09-10T10:00:00.000Z",
     ...
     "records":[
       {"id":"r1","kind":"administration","version":1,"event_at":"2026-09-07T07:00:00.000Z","data":{"occurrenceId":"x","phaseId":"p1","entryId":"e1",
    ...
    fun mapsProtocolLogsAndReportsSkips() {
        ...
        assertEquals(1, r.phases.size)
        assertEquals(LocalDate.parse("2026-08-01"), r.phases.single().startDate)
